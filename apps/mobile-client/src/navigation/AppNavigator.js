          ...
          try {
            ...
            if (newAccess) {
              ...
              registerFCMToken(newAccess).catch((err) =>
                console.warn(
                  "[AppNavigator] Soft-failure registering FCM:",
                  err.message,
                ),
              );
              ...
              try {
                ...
                console.log(
                  "[AppNavigator] Profile fetched on boot, name:",
                  user?.name,
                );
              } catch (profileErr) {
                console.warn(
                  "[AppNavigator] Profile fetch failed after refresh, using token data:",
                  profileErr?.message,
                );
              }
              ...
              console.log(
                "[AppNavigator] Boot complete — navigating to MainTabs",
              );
            }
          } catch (refreshErr) {
            console.log(
              "[AppNavigator] Boot refresh failed, going to Login:",
              refreshErr?.message,
            );
            // Stay on Login
          }
